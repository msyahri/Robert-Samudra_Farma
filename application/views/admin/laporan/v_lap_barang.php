        ...
        <table border="0" align="center" style="width:800px; border:none;margin-top:5px;margin-bottom:0px;">
            <tr>
                <td colspan="2" style="width:800px;padding-left:20px;">
                    <center>
                        <h4>LAPORAN DATA PRODUK APOTEK SAMUDRA</h4>
                    </center><br />
                </td>
            </tr>
    ...
    <td width='30%' align='center'>Stok</td>
            ...
            ?>
                <tr>
                    ...
                    <td style="vertical-align:center;padding-right:5px;text-align:right;"><?php echo 'Rp ' . number_format($d['barang_har_srp']); ?></td>
