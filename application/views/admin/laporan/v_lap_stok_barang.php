        ...
        <table border="0" align="center" style="width:800px; border:none;margin-top:5px;margin-bottom:0px;">
            <tr>
                <td colspan="2" style="width:800px;padding-left:20px;">
                    <center>
                        <h4>LAPORAN STOK BARANG APOTEK SAMUDRA</h4>
                    </center><br />
                </td>
            </tr>
        ...
        <table border="1" align="center" style="width:900px;margin-bottom:20px;">
            ...
            foreach ($data->result_array() as $d) {
                ...
                if ($group == '-' || $group != $d['toko_nama']) {
                    ...
                    echo "<tr><td colspan='4'><b>Kategori: $kat</b></td> </tr>";
                    echo "<tr style='background-color:#ccc;'>
    <td width='4%' align='center'>No</td>
    <td width='50%' align='center'>Nama Barang</td>
    ...
    <td width='30%' align='center'>Stok</td>
            ...
            ?>
                <tr>
                    ...
                    <td style="vertical-align:center;text-align:center;text-align:center;"><?php echo $d['tot_stok']; ?></td>
                </tr>
