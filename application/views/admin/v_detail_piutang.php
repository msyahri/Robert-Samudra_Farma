...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header">Data
                    <small>Detail Piutang</small>
                    <div class="pull-right"><a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span> Bayar piutang</a></div>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <?php
            foreach ($data_piutang->result_array() as $a) :
            $nofak_piutang = $a['piutang_id'];
            $status_piutang = $a['piutang_status'];
            $tempo_piutang = $a['piutang_tempo'];
        ...
        ?>
            <table class="table table-striped table-condensed">
                <tr>
                    <th>No Faktur</th>
                    <td><input name="kode" type="text" readonly class="form-control" value="<?php echo $nofak_piutang; ?>"></td>
                    <th>Tempo</th>
                    <td><input name="kode" type="text" readonly class="form-control" value="<?php echo $tempo_piutang; ?>"></td>
                </tr>
                <tr>
                    <th>Status</th>
                    <td><input name="kode" type="text" readonly class="form-control" value="<?php echo $status_piutang==1?"LUNAS":"BELUM LUNAS"; ?>"></td>
                    <th>Suplier</th>
        ...
        <?php
            foreach ($data_piutang_last->result_array() as $a) {
                            $id_piutang = $a['piutang_id'];
                            $id = $a['d_piutang_id'];
                            $awal = $a['piutang_sisa'];
                            $akhir = $a['piutang_bayar'];
                            $tgl = $a['tanggal']; 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Form Tambah Bayar piutang</h4>
                    </div>
                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/piutang/tambah_detail_piutang' ?>">
                            <div class="modal-body">
                                <input name="kode" type="hidden" value="<?php echo $id_piutang; ?>">
                                <div class="form-group">
                                    <label class="control-label col-xs-3">piutang saat ini</label>
                                    <div class="col-xs-9">
                                        <input name="awal" class="form-control" type="text" placeholder="piutang saat ini..." value="<?php echo $awal; ?>" style="width:280px;" id="add_awal" readonly>
                                    </div>
                                </div>
            ...
            <div id="modalEditPelanggan<?php echo $id ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="myModalLabel">Form Edit Bayar</h4>
                        </div>
                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/piutang/edit_detail_piutang' ?>">
                            <div class="modal-body">
                                <input name="kode" type="hidden" value="<?php echo $id; ?>">
                                
                                <div class="form-group">
                                    <label class="control-label col-xs-3">Detail piutang ID</label>
                                    <div class="col-xs-9">
                                        <input name="id_piutang" class="form-control" type="hidden" value="<?php echo $id_piutang; ?>" style="width:280px;" readonly>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-xs-3">piutang saat ini</label>
                                    <div class="col-xs-9">
                                        <input name="awal" class="form-control" type="text" placeholder="piutang saat ini..." value="<?php echo $awal; ?>" style="width:280px;" id="edit_awal<?= $i?>" readonly>
                                    </div>
                                </div>
            ...
            <div id="modalHapusPelanggan<?php echo $id ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="myModalLabel">Konfirmasi Hapus Detail piutang</h4>
                        </div>
                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/piutang/hapus_detail_piutang' ?>">
                            <div class="modal-body">
                                <p> Apakah anda yakin hapus data?</p>
                                <input name="kode" type="hidden" value="<?php echo $id; ?>">
                                <input name="kode_piutang" type="hidden" value="<?php echo $id_piutang; ?>">
                            </div>
                            <div class="modal-footer">
