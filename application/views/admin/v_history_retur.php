        ...
        <script type="text/javascript">
            $(document).ready(function(e){
              ...
              $('#mydata').DataTable({
                 ...
                 "order": [[0, "desc" ]],
                 "ajax":{
                          url :  base_url+'admin/retur/showRetur',
                          type : 'POST'
                        },
                 columns: [
               ...
               $('#mydata').on('click','.delete_record',function(){
                    var codeRetur=$(this).data('coderetur');
                    var codeImei=$(this).data('codeimei');
                    var qty=$(this).data('codeqty');
                    $('#ModalDelete').modal('show');
                    $('[name="kode_retur"]').val(codeRetur);
                    $('[name="kode_brg"]').val(codeImei);
                    $('[name="qty"]').val(qty);
                    document.getElementById("view_imei").innerHTML = codeImei; //untuk alert
              });
