                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= ($level == 1) ? "Admin" : "Kasir" ?></td>
                                <td><?= ($status == 1) ? "<a class='btn btn-xs btn-danger' href='#modalHapusPelanggan$id' data-toggle='modal' title='Hapus'><span class='fa fa-close'></span> Nonaktifkan</a>" : "<a class='btn btn-xs btn-success' href='#modalAktifPelanggan$id' data-toggle='modal' title='Aktif'><span class='fa fa-check'></span> Aktifan</a>" ?></td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/pengguna/aktifkan' ?>">
                            <div class="modal-body">
                                <p>Yakin aktifkan pengguna <b><?php echo $nm; ?></b>?</p>
                                <input name="kode" type="hidden" value="<?php echo $id; ?>">
                            </div>
                            <div class="modal-footer">
                                <button class="btn" data-dismiss="modal" aria-hidden="true">Tutup</button>
