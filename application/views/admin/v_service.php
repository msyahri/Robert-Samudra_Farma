...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="<?php echo base_url() . 'admin/service/add_to_cart' ?>" method="post">
                    <table>
                        <tr>
                    ...
                    <table>
                        <tr>
                            <th>Nama Service <p class="font-weight-light text-sm text-danger">Gunakan '_' untuk mengganti 'spasi'!</p></th>
                            <th>Harga Service(Rp)</th>
                            <th style="text-align: center;">Jumlah</th>
                        </tr>
                        <tr>
                            <td><input type="text" name="nama_service" style="width:300px;margin-right:5px;" class="form-control input-sm"></td>
                            <td><input type="text" name="harsrppot" style="width:200px;margin-right:5px;text-align:right;" class="form-control input-sm"></td>
                            <td><input type="text" name="stok" style="width:70px;margin-right:5px;" class="form-control input-sm"></td>
                ...
                <table class="table table-bordered table-condensed" style="font-size:11px;margin-top:10px;">
                    <thead>
                        <tr>
                            <th>Nama Service</th>
                            <th style="text-align:center;">Harga Service (Rp)</th>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($this->cart->contents() as $items) : ?>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;"><a href="<?php echo base_url() . 'admin/service/remove/' . $items['rowid']; ?>" class="btn btn-warning btn-xs"><span class="fa fa-close"></span> Batal</a></td>
                            </tr>
                ...
                <form action="<?php echo base_url() . 'admin/service/simpan_service' ?>" method="post">
                    <table>
                        <tr>
            ...
            <div class="modal fade" id="largeModalCaraBayar" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/service/tambah_cara_bayar' ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#kode_brg").on("input", function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url() . 'admin/service/get_barang'; ?>",
                        data: kobar,
