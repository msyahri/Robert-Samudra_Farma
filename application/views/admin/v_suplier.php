                ...
                <table class="table table-striped table-condensed" id="mydata">
                    ...
                    <tbody>
                        ...
                        foreach ($data->result_array() as $a) :
                            ...
                            $perusahaan = $a['suplier_perusahaan'];
                        ?>
                            <tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Form Tambah Supplier</h4>
                    </div>
                    <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/suplier/tambah_suplier' ?>">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input name="perusahaan" class="form-control" type="text" placeholder="Nama Perusahaan..." style="width:280px;" required>
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/suplier/edit_suplier' ?>">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-xs-3">Supplier ID</label>
                                    <div class="col-xs-9">
                                        <input name="nama" class="form-control" type="text" value="<?php echo $id; ?>" style="width:280px;" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-xs-3">Perusahaan</label>
                                    <div class="col-xs-9">
                                        <input name="perusahaan" class="form-control" type="text" placeholder="Nama Perusahaan..." value="<?php echo $perusahaan; ?>" style="width:280px;" required>
                                    </div>
                                </div>
            ...
            <div id="modalHapusPelanggan<?php echo $id ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="myModalLabel">Konfirmasi Hapus Supplier</h4>
                        </div>
                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/suplier/hapus_suplier' ?>">
                            <div class="modal-body">
                                <p> Apakah anda yakin hapus data <b><?php echo $nm; ?></b>?</p>
                                <input name="kode" type="hidden" value="<?php echo $id; ?>">
                            </div>
                            <div class="modal-footer">
